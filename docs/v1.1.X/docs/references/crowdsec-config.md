...
{{v11X.crowdsec.Name}} has a main `yaml` configuration file, usually located in `/etc/crowdsec/config.yaml`.
...
The path to the {{v11X.simulation.htmlname}} configuration.
...
The path to the {{v11X.profiles.htmlname}} configuration.
