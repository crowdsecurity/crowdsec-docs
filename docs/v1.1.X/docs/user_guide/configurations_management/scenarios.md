{{v11X.hub.htmlname}} allows you to find needed scenarios.
...
{{v11X.scenarios.Htmlname}} are yaml files in `{{v11X.config.crowdsec_dir}}scenarios/`.
...
[Link to scenarios reference documentation](/Crowdsec/v11/references/scenarios/)
