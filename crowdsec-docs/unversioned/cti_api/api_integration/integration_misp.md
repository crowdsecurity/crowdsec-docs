...
- A CrowdSec CTI API key. See [instructions to obtain it](https://docs.crowdsec.net/u/console/ip_reputation/api_keys/#create-cti-api-keys)
...
| `Plugin.Enrichment_crowdsec_api_key`                 | Yes       | String  | CrowdSec CTI  API key. See [instructions to obtain it](https://docs.crowdsec.net/u/console/ip_reputation/api_keys/#create-cti-api-keys)    |
