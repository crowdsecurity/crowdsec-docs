...
<div style={{ marginBottom: "2.5rem" }}>
  <div className="doc-eyebrow">Why CrowdSec CTI</div>
  <div className="doc-section-title">What makes it different</div>
  <p style={{ fontSize: "13px", color: "var(--ifm-color-emphasis-600)", marginBottom: "1rem" }}>
    Most IP reputation services tell you an IP is <em>"bad."</em> CrowdSec tells you <strong>what it was doing</strong> — data from real deployments detecting real attacks, not honeypots.
  </p>
  <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "8px" }}>
    {[
      ...
      <div key={title} className="doc-card" style={{ display: "flex", gap: "12px" }}>
        ...
        <div>
          ...
          <div style={{ fontSize: "12px", color: "var(--ifm-color-emphasis-600)", lineHeight: 1.55 }}>{desc}</div>
        </div>
      </div>
    ))}
  </div>
