...
OPNsense refers to this feature as **URL Table (IPs) aliases**, which allow you to create dynamic firewall aliases that automatically update from external URL sources.
