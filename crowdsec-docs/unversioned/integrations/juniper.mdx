...
Juniper refers to this feature as **Security Dynamic Address feeds**, which allow you to import and automatically update IP address lists from external feed servers.
