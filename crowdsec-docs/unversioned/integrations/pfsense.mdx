...
pfSense refers to this feature as **URL Table (IPs) aliases**, which are file-based aliases that periodically download and update IP lists from external URLs.
