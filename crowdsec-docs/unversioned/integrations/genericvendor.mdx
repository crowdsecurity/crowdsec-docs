...
The CrowdSec Generic Firewall integration allows you to block malicious IPs in your Generic Firewall firewall. This guide will walk you through the steps to integrate CrowdSec blocklists with your Generic Firewall firewall.
...
Once the integration is generated you will be presented with a credentials screen that will provide you with the necessary information to configure your Generic Firewall Firewall. This information will **ONLY** be displayed once, so please ensure you copy it down.
