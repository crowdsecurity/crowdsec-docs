...
F5 BIG-IP AFM refers to this feature as **IP Intelligence feed lists**, which allow you to import external threat intelligence to block or allow traffic based on IP reputation.
