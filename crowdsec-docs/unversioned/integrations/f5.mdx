...
## Create an F5 Integration Endpoint
...
The F5 format produces larger entries. When pulling **without compression**, keep `page_size` at or below **~90,000** entries to stay under the ~5 MB response limit; beyond that the response is truncated. Enabling compression avoids this limit entirely.
