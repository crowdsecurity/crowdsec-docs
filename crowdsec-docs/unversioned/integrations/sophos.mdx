...
Sophos refers to this feature as **Third-Party Threat Feeds**, which enable you to integrate external sources of IP addresses, domains, and URLs involved in threat activity.
