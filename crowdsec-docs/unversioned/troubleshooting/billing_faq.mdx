...
Log in to your account and make sure the correct organization is selected in the organization switcher in the top-left corner of the interface. Go to the `Settings` page and click on the `Billing and plans` entry menu.
