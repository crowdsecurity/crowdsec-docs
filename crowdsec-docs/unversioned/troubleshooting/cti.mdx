...
Please try to resolve your issue by reading [the documentation](../cti_api/intro.mdx). If you're unable to find a solution, don't hesitate to seek assistance in:
...
To be classified as a false positive, you need a technical justification for why your IP might be misclassified as a threat. This is reviewed and validated by CrowdSec.
