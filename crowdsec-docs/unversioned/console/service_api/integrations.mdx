...
:::warning
The `username` and `password` are only shown at creation time, so write them down. If you lose them,
...
| Juniper     | Basic Auth     | Yes           | [CrowdSec Juniper doc](/u/integrations/juniper)                                                                                                                                              | `juniper`    |
| MikroTik    | Basic Auth     | Yes           | [CrowdSec MikroTik doc](/u/integrations/mikrotik)                                                                                                                                            | `mikrotik`   |
| OPNsense    | Basic Auth     | Yes           | [CrowdSec OPNsense doc](/u/integrations/opnsense)                                                                                                                                            | `opnsense`   |
...
| pfSense     | Basic Auth     | Yes           | [CrowdSec pfSense doc](/u/integrations/pfsense)                                                                                                                                              | `pfsense`    |
...
The `plain_text` format consists of one IP per line, and should be supported by most devices. If a specific format is missing, reach out to us and we'll help you support it!
