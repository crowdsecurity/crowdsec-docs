...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/createAllowlist)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/listAllowlists)
...
:::note
The `expiration` field is optional and indicates when the IP should be deleted from the allowlist. Without an expiration, an IP stays in the allowlist forever.
:::
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/getAllowlistItems)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/updateAllowlistItem)
...
When [subscribing to allowlists](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/subscribeAllowlist), you can use various `entity_type` :

 - A [Security Engine](/u/getting_started/intro) (entity_type `engine`). [Remediation Components (Bouncers)](https://doc.crowdsec.net/u/bouncers/intro) connected to it will benefit from the allowlist.
 - A [Firewall Integration](/u/integrations/intro) (entity_type `firewall_integration`). This lets you benefit from allowlists directly on your existing firewall appliances (CISCO, F5, Palo Alto etc.) without having to install a Security Engine or "Bouncer".
 - A [Remediation Component Integration](/u/bouncers/intro) (entity_type `remediation_component_integration`). This allows to use a "Bouncer" directly without having to deploy a Security Engine.
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/subscribeAllowlist)
