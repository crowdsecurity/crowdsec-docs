...
When [subscribing to allowlists](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/subscribeAllowlist), you can use various `entity_type` :
 ...
 - A [Security Engine](/u/getting_started/intro) (entity_type `engine`). [Remediation Components (Bouncers)](/u/bouncers/intro) connected to it will benefit from the allowlist.
