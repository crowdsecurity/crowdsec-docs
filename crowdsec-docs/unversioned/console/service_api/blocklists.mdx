...
- A [Security Engine](/docs/next/intro) (`engine`). [Remediation Components (Bouncers)](/u/bouncers/intro) connected to it enforce the blocklist.
...
- A [Remediation Component](/u/bouncers/intro) (`remediation_component_integration`): use a bouncer directly without a Security Engine.
