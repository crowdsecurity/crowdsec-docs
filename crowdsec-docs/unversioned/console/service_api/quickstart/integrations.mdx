...
:::warning
The `username` and `password` will only be displayed at creation time, be sure to write them down. If you lose them, you can always regenerate them with the [`update`](https://admin.api.crowdsec.net/v1/docs#tag/Integrations/operation/updateIntegration) method.
:::
