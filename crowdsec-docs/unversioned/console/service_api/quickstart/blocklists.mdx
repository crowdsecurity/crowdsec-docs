...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Blocklists/createBlocklist)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Blocklists/addIpsToBlocklist)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Blocklists/getBlocklist)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Blocklists/subscribeBlocklist)
