...
```
 ...
 - [Redoc method link](https://admin.api.dev.crowdsec.net/v1/docs#tag/Allowlists/operation/createAllowlistItems)
...
When [subscribing to allowlists](https://admin.api.crowdsec.net/v1/docs#tag/Allowlists/operation/subscribeAllowlist), you can use various `entity_type` :
 ...
 - A [Security Engine](/u/getting_started/intro) (entity_type `engine`). [Remediation Components (Bouncers)](https://doc.crowdsec.net/u/bouncers/intro) connected to it will benefit of the allowlist.
 - A [Firewall Integration](/u/integrations/intro) (entity_type `firewall_integration`). This allows to use benefit from allowlists directly on your existing Firewall Appliances (CISCO, F5, Palo Alto etc.) without having to install a Security Engine or "Bouncer".
