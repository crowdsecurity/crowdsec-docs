...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Allowlists/createAllowlist)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Allowlists/listAllowlists)
...
```
 ...
 - [Redoc method link](https://admin.api.dev.crowdsec.net/v1/docs#/Allowlists/createAllowlistItems)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Allowlists/getAllowlistItems)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Allowlists/updateAllowlistItem)
...
```
 ...
 - [Redoc method link](https://admin.api.crowdsec.net/v1/docs#/Allowlists/subscribeAllowlist)
