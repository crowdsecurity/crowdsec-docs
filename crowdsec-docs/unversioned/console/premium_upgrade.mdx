...
- **Scalability**:
    ...
    - Automatization and API access for large-scale deployments
- **Advanced Threat Detection & qualification**:
    - Attack surge detection
    - Premium proactive blocking with AI powered blocklists
    - Background noise filtering

Features comparison can be found in our [pricing page](https://app.crowdsec.net/pricing).
...
When you first a Console account your workspace is your "Personal Account".  
...
- Have your **Dev / Test / Staging** Security Engines remain in your **Personal Account**
- Have your **Production** Security Engines in the new **Production** organization.
...
- Or via `cscsli`, re-enroll your Security Engines in the desired organization with the `--overwrite` flag to force moving it to the new organization.

After the transfer, the alerts will be reappearing in the new organization after a few minutes.
