...
<FeatureCard
	...
	metric="15k → 60k IPs"
	category="protection"
	description="Receive the top 60k most aggressive attackers targeting services like yours (up from 15k in Community). More attackers blocked before they reach your servers."
	comparison={{
		before: "Community: top 15k",
		after: "Premium: top 60k (×4)"
	}}
...
- **Better blocking**: Access to 60k+ IPs and organization-specific threat intel
...
<FeatureCard
	...
	comparison={{
		before: "Community: 120 calls/month",
		after: "Premium: 1500 calls/month"
	}}
...
<FeatureCard
	...
	metric="15k → 60k IPs"
	category="protection"
	description="Top 60k most aggressive attackers (up from 15k in Community)."
...
<FeatureCard
	...
	metric="15k → 60k IPs"
	category="protection"
	description="Access to 60k most aggressive IPs (vs 15k in Community)."
	link="/u/console/blocklists/overview"
/>
...
|---------|-----------|---------|
| **Community Blocklist** | Top 15k IPs | Top 60k IPs |
...
| **IP Reputation Lookups/Week (Console)** | 30 | 100 + more |
| **CTI API Calls/Month** | 120 | 1500 |
| **Service API (SAPI)** | ✗ | ✓ |
...
[Upgrade self-service](https://app.crowdsec.net/pricing) with a 30-day free trial, or contact our team for custom plans (enterprise, MSP, volume).
...
- [**Community Blocklist differences**](/docs/next/central_api/community_blocklist) - Understand the different community blocklists for non-contributing, contributing and paying users
