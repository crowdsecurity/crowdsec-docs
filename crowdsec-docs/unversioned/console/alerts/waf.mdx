...
<ThemedImage
    alt="The WAF view: application-layer signals broken down by rule"
    sources={{
        light: useBaseUrl("/img/console/alert-explorer/waf-view-light.png"),
        dark: useBaseUrl("/img/console/alert-explorer/waf-view-dark.png"),
    }}
/>
...
<ThemedImage
    alt="The WAF view empty state, pitching the AppSec component setup"
    sources={{
        light: useBaseUrl("/img/console/alert-explorer/waf-empty-light.png"),
        dark: useBaseUrl("/img/console/alert-explorer/waf-empty-dark.png"),
    }}
/>
