...
<ThemedImage
    alt="A breakdown chart with a greyed Out of quota band over an exceeded period"
    sources={{
...
The full picture lives on the **"Billing and Plans"** page of the organization settings, under the **"Usage"** section.

<ThemedImage
    alt="The Usage section of the Billing and Plans page, showing the alert quota consumption"
    sources={{
        light: useBaseUrl("/img/console/alert-explorer/quotas-usage-light.png"),
        dark: useBaseUrl("/img/console/alert-explorer/quotas-usage-dark.png"),
    }}
/>
