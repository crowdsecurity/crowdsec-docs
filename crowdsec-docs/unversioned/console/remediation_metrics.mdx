...
- [Cloudflare Workers](/u/bouncers/cloudflare)
...
- The blocklists that contribute to remediating malicious traffic
...
This section highlights the amount of malicious traffic that has been remediated by your bouncers. It includes both raw and estimated data on discarded requests, packets, and bytes.
