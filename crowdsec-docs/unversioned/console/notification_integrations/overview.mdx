...
> CrowdSec allows you to be linked to any notification integration. However, you need to be a ⭐ Premium organization to unlock the full potential of the notification integrations.
...
Blocking Known Safe IP | A known safe or legitimate IP address was blocked (false positive). |
