...
2. Select the Discord server you want to link to your CrowdSec Console using the dropdown menu at the top right of the page. Then select **Allow**. Repeat the process if you want to link more servers.
