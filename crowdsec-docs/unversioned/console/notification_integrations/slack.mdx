...
By default, Slack lets any workspace member add applications to it. If you want to learn more about it you can check [this Slack article](https://slack.com/intl/en-gb/help/articles/202035138-Add-apps-to-your-Slack-workspace).
...
2. Select the Slack workspace you want to link to your CrowdSec Console using the dropdown menu at the top right of the page. Then select **Allow**. Repeat the process if you want to link more workspaces.
...
If you're attempting to create or update a notification rule and are receiving the following error: "Slack rate limit exceeded.", you should enter channel ID instead of the channel Name and wait for a minute. If your workspace has a lot of channels, we advise you to enter the channel ID directly next time.
...
Read the CrowdSec privacy policy here: [Privacy policy](https://www.crowdsec.net/privacy-policy).