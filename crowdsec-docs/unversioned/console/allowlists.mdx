...
Centralized allowlists is a powerful feature that allows you to manage allowlists across all your security engines and integrations from a single location. On the free plan, you can still use [allowlists](/docs/next/local_api/centralized_allowlists) locally.
...
<ThemedImage
    alt="CrowdSec Allowlists Menu"
    sources={{
        light: useBaseUrl("/img/console/allowlists/allowlists-menu-light.png"),
        dark: useBaseUrl("/img/console/allowlists/allowlists-menu-dark.png"),
    }}
/>
...
<ThemedImage
    alt="CrowdSec Allowlists Create"
    sources={{
        light: useBaseUrl("/img/console/allowlists/allowlists-create-light.png"),
        dark: useBaseUrl("/img/console/allowlists/allowlists-create-dark.png"),
    }}
/>
...
<ThemedImage
    alt="CrowdSec Allowlists List"
    sources={{
        light: useBaseUrl("/img/console/allowlists/allowlists-list-light.png"),
        dark: useBaseUrl("/img/console/allowlists/allowlists-list-dark.png"),
    }}
/>

:::warning Important: Subscribe Entities After Creation

Creating an allowlist is only the first step. **The allowlist will not take effect until you subscribe at least one entity** (Security Engine, Integration, Tag, or Organization) to it. See [Subscribe to an allowlist](#subscribe-to-an-allowlist) below for details.
...
<ThemedImage
    alt="CrowdSec Allowlists Add Items"
    sources={{
        light: useBaseUrl("/img/console/allowlists/allowlists-add-items-light.png"),
        dark: useBaseUrl("/img/console/allowlists/allowlists-add-items-dark.png"),
    }}
/>
...
Click on the "Subscribe" button and select the integration for which you want to subscribe to the allowlist. You can subscribe multiple integrations, security engines, or the whole organization to the same allowlist. At the top of the subscription window, you can choose between the different types of subscriptions and then select the subscribers you want to add.

<ThemedImage
    alt="CrowdSec Allowlists Subscription"
    sources={{
        light: useBaseUrl("/img/console/allowlists/allowlists-subscription-light.png"),
        dark: useBaseUrl("/img/console/allowlists/allowlists-subscription-dark.png"),
    }}
/>
