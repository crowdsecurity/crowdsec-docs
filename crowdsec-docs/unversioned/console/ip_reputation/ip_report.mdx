...
Indicates the **blocklists** where the IP is currently listed. These are provided by CrowdSec to the community for preemptive blocking.
...
CrowdSec invites the community to participate in improving threat intelligence by:
...
This section provides a detailed **Security Engine Report** for the IP, showing how it interacted with your security stack:
