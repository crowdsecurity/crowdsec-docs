...
<ThemedImage
    alt="CrowdSec Advanced Search Page"
    sources={{
        light: useBaseUrl("/img/console/cti/advanced_search/page-light.png"),
        dark: useBaseUrl("/img/console/cti/advanced_search/page-dark.png"),
    }}
/>
