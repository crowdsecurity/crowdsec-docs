...
<div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "10px", marginBottom: "2rem" }}>
  ...
  <div className="doc-card" style={{ display: "flex", flexDirection: "column" }}>
    ...
    {/* Quota rows */}
    <div style={{ display: "flex", flexDirection: "column", gap: "4px", marginBottom: "10px", borderLeft: "2px solid var(--ifm-color-emphasis-200)", paddingLeft: "12px" }}>
      {[
    ...
    <div style={{ fontSize: "11px", color: "var(--ifm-color-emphasis-500)", lineHeight: 1.5, marginBottom: "12px" }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
      ...
      <Link to="/u/console/ip_reputation/api_keys_premium" style={{ fontSize: "12.5px", fontWeight: 600 }}><span>Quotas & plans →</span></Link>
