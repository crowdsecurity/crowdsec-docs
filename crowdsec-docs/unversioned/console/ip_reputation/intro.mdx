  ...
  <div style={{ display: "flex", gap: "14px", alignItems: "flex-start" }}>
    ...
    <div>
      ...
      <div style={{ fontSize: "12.5px", color: "var(--ifm-color-emphasis-600)", lineHeight: 1.6, marginBottom: "8px" }}>
        A dedicated platform tracking CVEs actively exploited in the wild: with exploitation momentum, opportunity scores, and the IPs behind each attack. Requires a dedicated API key; contact the CrowdSec team.
      </div>
