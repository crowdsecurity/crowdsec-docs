...
Different views are available based on the number of engines in an organization. If an organization has more than four engines, table views work best. (See below)
...
- **Enroll Date**
- **Tags**: Add custom tags to the engines (see [Name and Tags](/u/console/security_engines/name_and_tags)).
...
- **Activity**: This feature helps focus on Security Engines that require your attention. [Stack Health](/u/console/stackhealth) can identify problems in your stack.
