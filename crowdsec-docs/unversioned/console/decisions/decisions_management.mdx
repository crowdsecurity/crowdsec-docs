...
:::info
If running a version before v1.6.9, this feature needs the _console_management_ feature activated on your Security Engine.  
...
<ThemedImage
    alt="CrowdSec Decisions Management"
    sources={{
        light: useBaseUrl("/img/console/decisions/decisions-light.png"),
        dark: useBaseUrl("/img/console/decisions/decisions-dark.png"),
    }}
/>
...
- Then enter the IP address you want to ban, the remediation type, the duration, a reason and select the target of this decision:
  > In this example, we are adding a **ban** decision on **192.168.1.1** for **4h** because it is a **Bad IP**, to my two instances.

<ThemedImage
    alt="CrowdSec Add Decision"
    sources={{
        light: useBaseUrl("/img/console/decisions/add_decision-light.png"),
        dark: useBaseUrl("/img/console/decisions/add_decision-dark.png"),
    }}
/>
...
<ThemedImage
    alt="CrowdSec Delete Decision"
    sources={{
        light: useBaseUrl("/img/console/decisions/delete_decision-light.png"),
        dark: useBaseUrl("/img/console/decisions/delete_decision-dark.png"),
    }}
/>
...
<ThemedImage
    alt="CrowdSec Delete Decision Confirm"
    sources={{
        light: useBaseUrl("/img/console/decisions/delete_decision_confirm-light.png"),
        dark: useBaseUrl("/img/console/decisions/delete_decision_confirm-dark.png"),
    }}
/>
