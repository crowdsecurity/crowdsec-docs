...
<FeatureCard
	...
	category="scale"
	description="Provide view/edit/admin access to your customers or collaborate with team members by adding more seats to your organization. Base Premium plan includes 5 seats, with options to add more."
	comparison={{
...
<FeatureCard
	...
	metric="15k → 60k IPs"
	category="protection"
	description="Unlock the premium Community Blocklist as a network participant. Receive up to 60k of the most aggressive attackers targeting similar services as yours (up from top 15k in Community)."
	comparison={{
...
<FeatureCard
	...
	category="intelligence"
	badges={["API"]}
	description="Leverage CrowdSec IP reputation data into your vendors. Get 1500 CTI API calls per month (compared to 120 in Community) for integration with SIEM, SOAR, and other security tools."
	comparison={{
