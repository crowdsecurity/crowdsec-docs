...
<BouncerHeader
  ...
  featuresSupport="mtls, streammode, challenge"
...
- **Premium users** can enable [Remediation Sync](/u/console/integrations/intro) on their Console integration — decisions are forwarded from the LAPI without exposing it to the internet.
