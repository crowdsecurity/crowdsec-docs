...
:::tip
  We recommend using the **Self-Hosted Installer** setup method for most users wanting to connect CrowdSec [Blocklist Integration Endpoint](/u/integrations/remediationcomponent) into Cloudflare without any install on their part. It is simpler to install and maintain.  
