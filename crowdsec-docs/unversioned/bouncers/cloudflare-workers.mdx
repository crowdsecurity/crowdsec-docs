...
![Architecture](/img/bouncer/cloudflare-worker/cf-autonomous-init.png)
...
![Architecture](/img/bouncer/cloudflare-worker/cf-autonomous-sync.png)

4. This mode reduces infrastructure requirements as no persistent daemon is needed

![Architecture](/img/bouncer/cloudflare-worker/cf-autonomous-architecture.png)
