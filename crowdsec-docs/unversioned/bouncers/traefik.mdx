...
type: Opaque
stringData:
  BOUNCER_KEY_traefik: "<same-value-as-BOUNCER_KEY_traefik-above>"
```
...
<Tabs>
<TabItem value="mounted" label="Mounted Secret File" default>
...
<TabItem value="inline" label="Direct Key Example">
