...
description: "A Traefik middleware plugin that filters requests against CrowdSec decisions and the AppSec (WAF) engine, on bare metal, Docker Compose or Kubernetes."
sidebar_position: 5
---
...
<BouncerHeader
  ...
  featuresSupport="waf, metrics, prometheus, mtls, streammode"
  githubUrl="https://github.com/maxlerebourg/crowdsec-bouncer-traefik-plugin"
/>
...
documentation](https://github.com/maxlerebourg/crowdsec-bouncer-traefik-plugin).
...
- A working CrowdSec [Security Engine](/docs/next/intro) installation. For a
...
### Traefik configuration for source IPs
...
the Traefik pod and referenced with `crowdsecLapiKeyFile`.
:::
