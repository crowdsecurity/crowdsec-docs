...
This remediation generates MISP Feed from CrowdSec decisions. It exposes this Feed over HTTP/S.
...
The remediation will reset the feed every `misp_feed_reset_frequency` interval.
...
The log level for the remediation.
...
The log mode for the remediation.
