...
<BouncerHeader
  ...
  githubUrl="https://github.com/crowdsecurity/misp-feed-generator"
/>
...
```bash
sudo cscli -oraw bouncers add misp-feed-generator # -oraw flag can be discarded for human-friendly output.
```
...
Directory where the generated feed is written.
