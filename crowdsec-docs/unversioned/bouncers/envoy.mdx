...
:::important
This page covers remediation only. The Envoy bouncer described here does not
enable CrowdSec AppSec inspection.

If you want Envoy Gateway with WAF and virtual patching, follow the
