...
<BouncerHeader
  ...
  githubUrl="https://github.com/crowdsecurity/lua-cs-bouncer"
/>
...
which this integration depends on.

Do not use this for new deployments. If you are already using it, plan a migration
to another supported integration such as [Traefik](/docs/next/appsec/quickstart/traefik)
or [Envoy Gateway](/docs/next/appsec/quickstart/envoy-gateway).
:::
...
This component leverages OpenResty's Lua API and is loaded by the ingress-nginx controller as a [plugin](https://github.com/kubernetes/ingress-nginx/blob/controller-v1.11.8/rootfs/etc/nginx/lua/plugins/README.md).
...
First, you need to create a new ingress-nginx chart values file (`crowdsec-ingress-values.yaml`) to upgrade the ingress controller with the CrowdSec plugin.
  ...
  extraInitContainers:
    - name: init-clone-crowdsec-bouncer
      ...
      env:
        ...
        - name: APPSEC_CONNECT_TIMEOUT # connection timeout to the appsec, in ms, optional
          value: "100"
