...
description: "The PHP library behind CrowdSec's PHP bouncers. Use it to build your own remediation component, with decision lookups, CAPTCHA flows and AppSec (WAF) calls."
sidebar_position: 1
---
...
<BouncerHeader
  ...
  githubUrl="https://github.com/crowdsecurity/php-cs-bouncer"
/>
...
<img src={useBaseUrl('/img/bouncer/php-lib/screenshots/front-captcha.jpg')} alt="Captcha wall" title="Captcha wall" />
...
To test your component, you could add a decision to ban your own IP for 5 minutes, for example:
