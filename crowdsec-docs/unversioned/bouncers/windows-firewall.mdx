...
<BouncerHeader
  ...
  hubUrl="https://app.crowdsec.net/hub/author/crowdsecurity/remediation-components/cs-windows-firewall-bouncer"
/>
...
Whether to log to a file or to the console.
...
The component automatically selects the current profile, but you can override this behaviour with this parameter.
