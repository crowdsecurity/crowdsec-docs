...
The OpenResty bouncer can forward HTTP requests to the CrowdSec AppSec Component for real-time inspection, giving you virtual patching and protection against known CVEs and generic attack patterns.
...
Add the following to `/etc/crowdsec/bouncers/crowdsec-openresty-bouncer.conf`:
