...
<BouncerHeader
  ...
  githubUrl="https://github.com/crowdsecurity/cs-apache2-bouncer"
  hubUrl="https://app.crowdsec.net/hub/author/crowdsecurity/remediation-components/cs-apache2-bouncer"
/>
...
This component leverages Apache's module mechanism to provide IP address blocking capability.
...
The module can be built and installed on other platforms as well.
...
The Remediation Component configuration is located in `/etc/crowdsec/bouncers/crowdsec-apache2-bouncer.conf`:
...
Behavior can be overridden in any location.
...
If you want to return custom HTTP code and/or content, you can use `CrowdsecLocation` and `RewriteRule`:
