...
For a CVE, get:
 ...
 - CrowdSec Analysis: A human readable text covering the most important information about the vulnerability, such as exploitation pattern, current momentum etc.
 - CrowdSec Scores:
...
**CTI Information**
 - List of IPs exploiting the vulnerability over a given period, with [their associated information](https://doc.crowdsec.net/u/cti_api/taxonomy/cti_object), from reputation to known classifications.
