...
Not all CVEs deserve the same urgency. The Live Exploit Tracker provides **three complementary scores** and an **exploitation phase** classification to help you decide where to focus:
...
- **[REST API](/tracker_api/api_authentication)**: Programmatic access for automation, SIEM/SOAR integration, and custom tooling. A [Python SDK](https://github.com/crowdsecurity/crowdsec-tracker-api-sdk-python) is also available.
