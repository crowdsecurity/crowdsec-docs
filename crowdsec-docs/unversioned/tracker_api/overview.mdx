...
- **Exploitation Phase**: Where the CVE sits in its lifecycle — from *insufficient data* through *background noise* to *active exploitation*.
...
→ [Learn more about Scores & Ratings](./scores.mdx)

→ [Learn more about Exploitation Phases](./exploitation_phases.mdx)
...
→ [Learn more about Reconnaissance Rules vs CVEs](./fingerprints_vs_cves.mdx)
...
- **[REST API](./api_authentication.mdx)**: Programmatic access for automation, SIEM/SOAR integration, and custom tooling. A [Python SDK](https://github.com/crowdsecurity/crowdsec-service-api-sdk-python) is also available.
...
|---|---|
| Protect my technology stack by vendor | [Vendor Subscriptions](./api_lookups.mdx#subscribe-an-integration-to-a-vendor) |
| Understand what the scores mean | [Scores & Ratings](./scores.mdx) |
| Browse CVEs and assess threats | [Web Interface Guide](./web_interface.mdx) |
| Automate with the API | [API Authentication & Setup](./api_authentication.mdx) |
| Block attacker IPs on my firewall | [Integrations & Blocklists](./api_integrations.mdx) |
| Investigate a specific alert | [Triage Workflow Guide](./guide_triage.mdx) |
| Set up proactive monitoring | [Proactive Monitoring Guide](./guide_proactive.mdx) |
