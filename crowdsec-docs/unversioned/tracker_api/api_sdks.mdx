...
Need the API in another language? The REST API is straightforward to call from any HTTP client — see [Authentication & Setup](./api_authentication.mdx) for the base URL and authentication details, and the [API Reference](https://admin.api.crowdsec.net/v1/docs#tag/Cves) for the full OpenAPI specification.
