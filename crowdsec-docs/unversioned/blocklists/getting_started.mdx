...
<ConsolePromo
    ...
    link="/u/getting_started/pre_requisites#operating-system"
/>
<br/>
<ConsolePromo
    title="Integrations"
...
/>
<br/>
If you're new to CrowdSec, and want to use blocklists we recommend starting with the [Integrations guide](integrations/intro.md), however, if you are unsure where to start, feel free to browse our [main website for more information](https://www.crowdsec.net/).
