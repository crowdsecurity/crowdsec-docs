...
The `cscli metrics` allows you to see a subset of the metrics exposed by crowdsec. For a more industrial solution, look into the [Grafana](/observability/prometheus.md) integration. <!-- why is the link not working ?-->
...
<details>
<summary>cscli metrics show engine</summary>
