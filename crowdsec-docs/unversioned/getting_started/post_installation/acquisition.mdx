...
If you have detected services, then in the previous output you can see columns running from `Lines read` to `Lines whitelisted`.
...
If you already see all services you want covered by the then you can [head back to the post installation guide.](/getting_started/next_steps.md)
