  ...
  <TabItem value="windows">
    ...
    values={[
      ...
      <TabItem value="powershell">
          ```bash
          New-Item -ItemType Directory -Force -Path C:\Program Files\CrowdSec\Config\acquis.d\
          ```
      </TabItem>
      <TabItem value="terminal">
          ```bash
          mkdir "C:\Program Files\CrowdSec\Config\acquis.d\"
          ```
      </TabItem>
    </Tabs>
  </TabItem>
...
<Tabs
  ...
  <TabItem value="windows">
    ...
    values={[
      ...
      <TabItem value="powershell">
          ```bash
          New-Item -ItemType File -Force -Path C:\Program Files\CrowdSec\Config\acquis.d\<collection_name>.yaml
          ```
      </TabItem>
      <TabItem value="terminal">
          ```bash
          .>C:\Program Files\CrowdSec\Config\acquis.d\<collection_name>.yaml 2>NUL
          ```
      </TabItem>
    </Tabs>
  </TabItem>
