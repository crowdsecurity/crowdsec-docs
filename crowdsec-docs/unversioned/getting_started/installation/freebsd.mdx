...
:::warning
Before starting the firewall bouncer in `pf` mode, ensure your `/etc/pf.conf` defines the CrowdSec tables and blocking rules. See the [Firewall Remediation Component pf setup guide](/u/bouncers/firewall#pf-setup-freebsd).
:::
