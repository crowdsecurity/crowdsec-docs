...
Use an **AppSec-capable** bouncer to get real-time WAF protection and virtual patching. For Docker and Kubernetes environments, the [Traefik bouncer plugin](/bouncers/traefik.mdx) is a natural fit. If you use Nginx as a reverse proxy, see the [Nginx bouncer](/bouncers/nginx.mdx).
