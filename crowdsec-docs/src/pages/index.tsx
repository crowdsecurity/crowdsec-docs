      ...
      <main>
        ...
        <section style={{ position: 'relative', padding: '92px 24px 48px', textAlign: 'center', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            background: 'radial-gradient(ellipse 600px 280px at 50% 80px, color-mix(in srgb, var(--cs-orange) 13%, transparent), transparent 70%)',
            pointerEvents: 'none',
          }} aria-hidden="true" />
          ...
          <div style={{
            position: 'absolute', inset: 0,
            backgroundImage: 'linear-gradient(var(--cs-border-hi) 1px, transparent 1px), linear-gradient(90deg, var(--cs-border-hi) 1px, transparent 1px)',
          ...
          <div style={{ position: 'relative', maxWidth: 760, margin: '0 auto' }}>
            ...
            <div style={{
              ...
              marginBottom: 28,
              fontFamily: 'var(--cs-font-mono)', fontSize: 11.5, color: 'var(--cs-orange)',
            ...
            <p style={{
              marginTop: 20, fontSize: 17, color: 'var(--cs-ink-dim)', lineHeight: 1.5,
              maxWidth: 520, marginLeft: 'auto', marginRight: 'auto',
            }}>
              Three paths — one platform. Detect attacks at the edge, push curated threat feeds into your stack, or query intel on demand.
            </p>
        ...
        <div style={{ maxWidth: 940, margin: '0 auto', padding: '0 24px 80px' }}>
          ...
          <PathCards>
            <PathCard
              eyebrow="01 · DETECT"
              color={CS_ORANGE}
              icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 3l8 3v6c0 4.5-3.4 8.4-8 9-4.6-.6-8-4.5-8-9V6l8-3z"/></svg>}
          ...
          <div style={{
            ...
            margin: '40px auto 22px', maxWidth: 360, justifyContent: 'center',
          }}>
            <div style={{ height: 1, flex: 1, background: 'var(--cs-border)' }} />
            <div style={{
              fontFamily: 'var(--cs-font-mono)', fontSize: 11,
              letterSpacing: '0.14em', textTransform: 'uppercase',
              color: 'var(--cs-ink-mute)', fontWeight: 500,
            }}>
              How each path works
            </div>
            <div style={{ height: 1, flex: 1, background: 'var(--cs-border)' }} />
