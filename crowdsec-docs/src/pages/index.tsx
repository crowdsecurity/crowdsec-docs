...
const HomePageHeader = (): React.JSX.Element => {
	return (
		<section className={clsx("hero tw-bg-gray-900 tw-flex-1 relative", styles.heroBanner)}>
				...
				<div>
					<div className="tw-flex tw-gap-4 tw-justify-between tw-flex-col-reverse md:tw-flex-row tw-items-center md:tw-items-start">
						<div className="tw-text-left tw-w-full">
							<h1 className="tw-mb-1 tw-text-white">Welcome to the CrowdSec Documentation</h1>
						...
						<img alt="CrowdSec Logo" src="/img/crowdsec_logo.png" className="tw-h-20 tw-w-28 md:tw-h-24 md:tw-w-auto" />
					</div>
