...
const staticData: StaticData[] = [
	{
		icon: () => <img src="/img/crowdsec_logo.png" className="tw-h-6 tw-w-9" alt="CrowdSec logo" />,
	...
	{
		icon: () => <img src="/img/icons/radar-target.webp" className="tw-h-6 tw-w-6" alt="security engines" />,
	...
	{
		icon: () => <img src="/img/icons/waf.webp" className="tw-h-6 tw-w-6" alt="Web application firewall" />,
		title: "CrowdSec WAF",
		description: "Protect your web applications.",
		link: "/docs/appsec/intro",
	},
	{
		icon: () => <img src="/img/icons/shield.webp" className="tw-h-6 tw-w-6" alt="blocklists" />,
		title: "Blocklists",
		description: "Block thousands of IPs.",
		link: "/u/blocklists/intro",
	},
	{
		icon: () => <img src="/img/icons/world.webp" className="tw-h-6 tw-w-6" alt="world API" />,
		title: "APIs",
			...
			<div className="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4">
				{staticData.map((props, index) => (
					<Link
						key={props.title}
						href={props.link}
						className={`tw-border-0 hover:tw-no-underline ${index === 0 ? "md:tw-col-span-2" : ""}`}
					>
						<div
							className={
						...
						>
							...
							<div className="tw-flex tw-flex-col tw-items-start tw-flex-1">
								<span className={"tw-text-md tw-font-bold tw-flex-1"}>{props.title}</span>
								<p className="tw-text-sm tw-text-left tw-text-gray-300 tw-mb-0">{props.description}</p>
							</div>
						</div>
					</Link>
				))}
