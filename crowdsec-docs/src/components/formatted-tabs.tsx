...
const FormattedTabs = ({ ...props }): React.JSX.Element => {
	...
	return (
		<Tabs defaultValue={defaultValue} groupId="console-operating-systems" values={values}>
			<TabItem value="nix">
			...
			<TabItem value="docker">
				{props.docker !== undefined && props.dockerCompose === undefined ? (
			...
			<TabItem value="kubernetes">
				{props.yaml !== undefined ? <CodeBlock language="yaml">{props.yaml}</CodeBlock> : null}
