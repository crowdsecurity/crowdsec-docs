...
const FEATURES_LIST = [
    {
        ...
        description: (
            <>
                CrowdSec is easy to install, deploy and use regardless of your
                knowledge. You don't need to be a security master to enjoy its
                full capabilities.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                CrowdSec is able to process both live and old logs, which makes
                it false-positive resilient.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                CrowdSec is instrumented with Metabase & Prometheus to generate
                out-of-the-box dashboards and monitor activity across your
                assets.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                All components communicate via HTTP API, making it easy to cover
                complex setups.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                You can share malevolent IP data with your fellow users, have
                each other's backs and outnumber hackers.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                CrowdSec is as open source and free as it can be through an MIT
                license. No back doors. No shenanigans.
            </>
        ),
    },
    //community driven ->
