...
module.exports = {
  ...
  tutorialSidebar: [
      ...
      items: [
        {
          ...
          items: [
            ...
            {"type":"link", "label": "Docker", "href":"https://hub.docker.com/r/crowdsecurity/crowdsec"},
          ]
        },
        {
          type: 'doc',
    ...
    },
    {
      ...
      items: ["data_sources/file", "data_sources/journald", "data_sources/cloudwatch", "data_sources/kinesis", "data_sources/syslog", "data_sources/docker", "data_sources/windows_evt_log", "data_sources/kafka", "data_sources/kubernetes_audit", "data_sources/s3", "data_sources/troubleshoot" ]
    },
    {
      type: 'category',
      label: 'Parsers',
      ...
      items: ["parsers/format","parsers/create", "parsers/enricher", "parsers/patterns"]
    },
    {
      type: 'category',
      label: 'Scenarios',
      ...
      items: ["scenarios/format", "scenarios/simulation","scenarios/create" ]
    },
    {
      type: 'category',
      label: 'Collections',
    ...
    },
    {
      ...
      items: ["observability/cscli", "observability/prometheus", "observability/dashboard", "observability/pprof"]
    },
    {
      type: 'category',
      label: 'Local API',
      ...
      items: ["local_api/database" , "local_api/bouncers", "local_api/tls_auth", {"type":"link", "label": "Swagger", "href":"https://crowdsecurity.github.io/api_doc/lapi/"}]
    },
    {
      type: 'category',
      label: 'Central API',
      ...
      items: [{"type":"link", "label": "Swagger", "href":"https://crowdsecurity.github.io/api_doc/capi/"}]
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: ["contributing/contributing_doc", "contributing/contributing_hub", "contributing/contributing_bouncers", "contributing/contributing_test_env", "contributing/contributing_crowdsec"]
    },
    {
      type: 'doc',
      label: 'Console',
  ...
  cscliSidebar: [
        ...
        },
        {
          ...
          items: ["cscli/cscli_bouncers_add","cscli/cscli_bouncers_delete",
        ...
        },
        {
          ...
          items: ["cscli/cscli_collections_inspect","cscli/cscli_collections_install",
        ...
        },
        {
          ...
          items: ["cscli/cscli_config_backup","cscli/cscli_config_feature-flags","cscli/cscli_config_restore",
        ...
        },
        {
          ...
          items: ["cscli/cscli_console_disable","cscli/cscli_console_enable","cscli/cscli_console_enroll","cscli/cscli_console_status"]
        },
        {
          type: "category",
        ...
        },
        {
          ...
          items: ["cscli/cscli_hub_list","cscli/cscli_hub_update","cscli/cscli_hub_upgrade"]
        },
        {
          type: "doc",
          label: "cscli explain",
        ...
        },
        {
          ...
          items: ["cscli/cscli_lapi_context","cscli/cscli_lapi_context_add","cscli/cscli_lapi_context_delete","cscli/cscli_lapi_context_detect","cscli/cscli_lapi_context_status","cscli/cscli_lapi_register","cscli/cscli_lapi_status"]
        },
        {
          type: "category",
          ...
          items: ["cscli/cscli_machines_add","cscli/cscli_machines_delete","cscli/cscli_machines_list","cscli/cscli_machines_validate"]
        },
        {
          type: "doc",
          label: "cscli metrics",
        ...
        },
        {
          ...
          items: ["cscli/cscli_notifications_inspect","cscli/cscli_notifications_list","cscli/cscli_notifications_reinject"]
        },
        {
          type: "category",
          label: "cscli parsers",
          ...
          items: ["cscli/cscli_parsers_inspect","cscli/cscli_parsers_install","cscli/cscli_parsers_list","cscli/cscli_parsers_remove","cscli/cscli_parsers_upgrade"]
        },
        {
          type: "category",
          ...
          items: ["cscli/cscli_postoverflows_inspect","cscli/cscli_postoverflows_install","cscli/cscli_postoverflows_list","cscli/cscli_postoverflows_remove","cscli/cscli_postoverflows_upgrade"]
        },
        {
          type: "category",
          ...
          items: ["cscli/cscli_scenarios_inspect","cscli/cscli_scenarios_install","cscli/cscli_scenarios_list","cscli/cscli_scenarios_remove","cscli/cscli_scenarios_upgrade"]
        },
        {
          type: "category",
          label: "cscli support",
        ...
        },
        {
          ...
          items: ["cscli/cscli_hubtest_create","cscli/cscli_hubtest_run","cscli/cscli_hubtest_eval","cscli/cscli_hubtest_explain","cscli/cscli_hubtest_coverage", "cscli/cscli_hubtest_info", "cscli/cscli_hubtest_list", "cscli/cscli_hubtest_clean"]
        },
        {
          type: "category",
