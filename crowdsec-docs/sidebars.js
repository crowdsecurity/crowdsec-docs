...
module.exports = {
  ...
  tutorialSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'Data Sources',
      items: ["data_sources/intro", "data_sources/file", "data_sources/journald", "data_sources/cloudwatch", "data_sources/syslog", "data_sources/docker", "data_sources/troubleshoot" ]
    },
    {
      type: 'category',
      label: 'Parsers',
