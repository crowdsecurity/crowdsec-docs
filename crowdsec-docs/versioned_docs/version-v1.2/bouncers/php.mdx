...
Download the Github reposository of the bouncer.
...
Note: don't run the script as root but your password might be ask during the installation process.
...
Clone the Github reposository and run the upgrade script:
