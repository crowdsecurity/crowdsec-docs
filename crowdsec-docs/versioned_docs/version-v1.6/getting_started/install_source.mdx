...
- RE2
  <Tabs
    ...
    <TabItem value="RPM">
        <CodeBlock className="language-bash">dnf install re2-devel gcc-c++</CodeBlock>
    </TabItem>
    <TabItem value="Arch">
...
If you would like to have a hands off installation then you can run `sudo ./wizard.sh --unattended`.
