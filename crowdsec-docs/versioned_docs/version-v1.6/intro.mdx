...
CrowdSec is a modular security tool offering [behavior-based detection](https://app.crowdsec.net/hub/collections), including [AppSec rules](https://app.crowdsec.net/hub/waf-rules), and optional components to block threats called [Remediation Components](https://app.crowdsec.net/hub/remediation-components)
