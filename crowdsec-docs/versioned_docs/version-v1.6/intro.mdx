...
-   **Simplified Daily Operations**: You have access to our Web UI administration via [CrowdSec's console](http://app.crowdsec.net) or the powerful [Command line tool cscli](/cscli/intro.md) for effortless maintenance and keeping your detection mechanisms up-to-date.
