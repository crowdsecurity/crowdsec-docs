...
You now have the Security Engine running ! You can move forward and install a [remediation component](/u/bouncers/intro), or take a [tour](/getting_started/crowdsec_tour.md) of the software beforehand !
...
Please reffer to [remediation components](/u/bouncers/intro) section about different components we have.
:::
