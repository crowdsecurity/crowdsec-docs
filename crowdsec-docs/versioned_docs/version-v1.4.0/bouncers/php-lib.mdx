...
You can use this library to develop your own PHP application bouncer. Any custom bouncer should extend the [`AbstractBouncer`](https://github.com/crowdsecurity/php-cs-bouncer/blob/main/src/AbstractBouncer.php) class.
