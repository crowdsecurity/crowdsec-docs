...
This module allows the `Security Engine` to acquire logs from an S3 bucket.

It supports reading plain text files and gzip files (detection is performed based on the file extension).
