...
description: "Progressively harden your CrowdSec Web Application Firewall (WAF) deployment, from basic virtual patching to multi-layer protection with the OWASP CRS."
sidebar_position: 6
---
...
You can do so by using either official or custom CRS plugins. Refer to [this documentation](/appsec/crs/plugin_support.md) for a general plugin overview and [this page](/appsec/crs/customization.md) for some examples.
...
Refer to [this documentation](/appsec/crs/plugin_support.md) for a general plugin overview and [this page](/appsec/crs/customization.md) for instructions on how to write a custom plugin.
