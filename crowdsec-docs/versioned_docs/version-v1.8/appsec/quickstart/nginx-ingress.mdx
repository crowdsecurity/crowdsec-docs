---
id: nginx-ingress
title: "NGINX Ingress WAF QuickStart (Helm)"
sidebar_label: "QuickStart - NGINX Ingress (Helm)"
description: "Deploy and configure CrowdSec Open Source Web Application Firewall (WAF) on Kubernetes with Helm and protect the services exposed through your NGINX Ingress Controller."
---
...
This snippet enables the CrowdSec Lua plugin, allocates shared memory for
...
This should list the CrowdSec Lua plugin files.
...
```bash title="kubectl exec -n crowdsec -ti crowdsec-appsec-<pod-name> -- cscli metrics show appsec"
Appsec Metrics:
╭─────────────────┬───────────┬─────────╮
