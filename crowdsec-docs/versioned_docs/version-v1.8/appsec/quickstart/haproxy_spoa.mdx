...
description: "Deploy and configure CrowdSec Open Source Web Application Firewall (WAF) to protect applications behind HAProxy, using the SPOA remediation component to forward requests."
---
...
4. The request matched the [`vpatch-env-access`](https://app.crowdsec.net/hub/author/crowdsecurity/waf-rules/vpatch-env-access) rule.
