...
<Tabs
  ...
  <TabItem value="debian">
    <CodeBlock className="language-bash">sudo apt install crowdsec-firewall-bouncer-iptables</CodeBlock>
  </TabItem>
  
  <TabItem value="centos7">
      <CodeBlock className="language-bash">sudo yum install crowdsec-firewall-bouncer-iptables</CodeBlock>
  </TabItem>
  <TabItem value="centos8">
    <CodeBlock className="language-bash">sudo dnf install crowdsec-firewall-bouncer-iptables</CodeBlock>
  </TabItem>
  <TabItem value="amz">
    <CodeBlock className="language-bash">sudo yum install crowdsec-firewall-bouncer-iptables</CodeBlock>
  </TabItem>
  <TabItem value="freebsd">
    ...
    On FreeBSD bouncer configuration isn't taken care of at installation time. So a bit of a
    [bouncer](/bouncers/intro.md) configuration is needed. The bouncer configuration file is located at
    `/usr/local/etc/crowdsec-firewall-bouncer/crowdsec-firewall-bouncer.yaml`.
