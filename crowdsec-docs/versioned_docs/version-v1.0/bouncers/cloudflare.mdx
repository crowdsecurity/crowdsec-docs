...
**WARNING**: This bouncer does not work for this version of Crowdsec.
...
![image](https://raw.githubusercontent.com/crowdsecurity/cs-cloudflare-bouncer/main/docs/v1.0/assets/token_permissions.png)
