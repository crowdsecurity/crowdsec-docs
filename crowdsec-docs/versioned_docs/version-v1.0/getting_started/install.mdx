...
You now have crowdsec running ! You can move forward and install a [bouncer](/u/bouncers/intro), or take a [tour](/docs/v1.0/getting_started/crowdsec_tour) of the software beforehand !
