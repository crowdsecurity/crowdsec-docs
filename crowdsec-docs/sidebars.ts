...
const sidebarsConfig: SidebarConfig = {
		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					items: ["log_processor/collections/format"],
				},
				{
					type: "category",
					label: "Whitelists",
	...
	cscliSidebar: [
		...
		},
		{
			...
			items: ["cscli/cscli_config_feature-flags", "cscli/cscli_config_show"],
		},
		{
			type: "category",
			label: "cscli console",
		...
		},
		{
			...
			items: ["cscli/cscli_metrics_list", "cscli/cscli_metrics_show"],
		},
		{
			type: "category",
	...
	appSecSideBar: [
		...
		},
		{
			...
			label: "Bot detection",
			items: [
				{ type: "doc", id: "appsec/bot_detection/intro" },
