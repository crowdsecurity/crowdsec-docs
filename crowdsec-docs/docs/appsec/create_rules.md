...
description: "Write a CrowdSec WAF rule and its functional tests from scratch, using a worked shell injection example you can follow through to a Hub submission."
sidebar_position: 3
---
