...
description: "Validate incoming HTTP requests against an OpenAPI 3 schema with the CrowdSec WAF, rejecting anything that does not match your API before it reaches the app."
sidebar_position: 5
---
