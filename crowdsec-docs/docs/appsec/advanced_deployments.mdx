...
- Add: [`crowdsecurity/appsec-crs`](https://app.crowdsec.net/hub/author/crowdsecurity/collections/crowdsecurity/appsec-crs) (out-of-band) alongside existing virtual patching
