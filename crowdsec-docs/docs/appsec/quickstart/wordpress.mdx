---
id: wordpress
title: "WordPress WAF QuickStart"
sidebar_label: "QuickStart - WordPress"
description: "Protect a WordPress site with CrowdSec's open-source Web Application Firewall (WAF), using the WordPress bouncer plugin and the AppSec Component."
---
...
From any machine, send a request with a malicious body through WordPress — this example trips the [`vpatch-CVE-2022-22965`](https://app.crowdsec.net/hub/author/crowdsecurity/waf-rules/vpatch-CVE-2022-22965) rule (Spring4Shell):
