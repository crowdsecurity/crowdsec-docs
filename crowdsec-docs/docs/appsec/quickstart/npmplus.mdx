---
id: npmplus
title: "NPMplus WAF QuickStart"
sidebar_label: "QuickStart - NPMplus"
description: "Run CrowdSec's open-source Web Application Firewall (WAF) behind NPMplus, an Nginx Proxy Manager fork, using Docker Compose and the NPMplus admin UI."
---
...
3. AppSec matched the [`vpatch-env-access`](https://app.crowdsec.net/hub/author/crowdsecurity/waf-rules/vpatch-env-access) rule and answered `403`.
