...
description: "Deploy a custom CrowdSec WAF rule on your host, from a local YAML file to a loaded and verified rule, with a worked example you can copy command by command."
sidebar_position: 81
---
