...
description: "Use OWASP CRS plugins with the CrowdSec WAF to extend or fine-tune the rule set per application, and where to place config, before and after plugin files."
sidebar_position: 1
---
