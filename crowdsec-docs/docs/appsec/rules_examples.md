...
description: "Real CrowdSec WAF rule examples from the Hub, each with the rule definition, a matching HTTP request, and an explanation of the capability it demonstrates."
sidebar_position: 81
---
