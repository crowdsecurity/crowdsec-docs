...
<Tabs
  ...
  <TabItem value="nix">
    <CodeBlock className="language-bash">sudo cscli console enroll $ID --force</CodeBlock>
  </TabItem>
  <TabItem value="windows">
    <CodeBlock className="language-bash">cscli.exe console enroll $ID --force</CodeBlock>
  </TabItem>
</Tabs>