...
:::warn
Cache size will affect the number of events you receive within the postoverflow object. If you set a cache size to 5, you will only receive the last 6 events (Cache size including the overflow) in the postoverflow object. Any pipelines that rely on the postoverflow object will be affected by this (Notification, Profiles, Postoverflow).
:::
