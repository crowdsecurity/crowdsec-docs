...
You now have crowdsec running ! You can move forward and install a [bouncer](/docs/bouncers/intro), or take a [tour](/docs/getting_started/crowdsec_tour) of the software beforehand !


:::caution

Keep in mind that CrowdSec is only in charge of the "detection", and won't block anything on its own.
You need to deploy a [bouncer](/docs/bouncers/intro) to "apply" decisions.
