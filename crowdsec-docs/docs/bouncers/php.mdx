...
the [Crowdsec php bouncer library](https://github.com/crowdsecurity/php-cs-bouncer) to offer bouncer/IPS capability directly in your PHP application.
...
- Requires PHP extensions : `ext-json`, `ext-gd` (and `ext-curl` if you choose Curl as request handler)
