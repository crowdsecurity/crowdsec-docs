...
If you want to use reCAPTCHA with your Nginx Bouncer, you must provide a reCAPTCHA Site key and Secret key in your bouncer configuration ([recaptcha documentation](https://developers.google.com/recaptcha/intro)).
...
The best way to migrate from the crowdsec-nginx-bouncer v0.* to v1 is to reinstall the bouncer. Indeed, many new configurations options are now available and some has been removed.
