...
IPSet (when using `iptables` mode) does not support a timeout greater than 2147483647 seconds (about 596 hours). If crowdsec is configured to take decisions longer than that, the bouncer will be unable to insert the decisions.
...
IPSet does not support a timeout greater than 2147483647 seconds (about 596 hours). If crowdsec is configured to take decisions longer than that, the bouncer will be unable to insert the decisions.
